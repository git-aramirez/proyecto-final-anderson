      ...
      return(
        <View style={{ width:250 ,height:600}}>
          ...
          <DataTable id="tabla">
            ...
            <DataTable.Row>
              <DataTable.Cell ><TextInput multiline={true} numberOfLines={13} value={listaProcesos} onChangeText={(data)=>updateListaProcesos(data)} style={styles.textInput_table_ea}/></DataTable.Cell>
                ...
                <View style={{flexDirection: 'column'}}>
                  {listaRequerimientos.map((row,index) => (
                      <Picker style={{marginLeft:20 , height: 33, fontSize:13}} value={row} onValueChange={(data)=>updateListaRequerimientos(index,data)}>
                        ...
                        <Picker.Item label={"Solicitar 5"}  value={"Solicitar 5"}/>
                        <Picker.Item label={"Solicitar 6"}  value={"Solicitar 6"}/>
                        <Picker.Item label={"Solicitar 7"}  value={"Solicitar 7"}/>
                        <Picker.Item label={"Solicitar 8"}  value={"Solicitar 8"}/>
                        <Picker.Item label={"Solicitar 9"}  value={"Solicitar 9"}/>
                        <Picker.Item label={"Solicitar 10"}  value={"Solicitar 10"}/>
