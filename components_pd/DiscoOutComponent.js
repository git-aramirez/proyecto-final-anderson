...
const DiscoOutComponent = (props) => {
  ...
  return(
    <View style={{width:'100%',height:250,justifyContent: 'center',alignItems: 'center',flexDirection: 'column',borderWidth: 1 }}>
       ...
       <Text style={{fontSize:15}}> [ {items[0]} {discosGlobales[posicionDisco][0]} ]
        [ {items[1]} {discosGlobales[posicionDisco][1]} ] [{items[2]} {discosGlobales[posicionDisco][2]} ]</Text>
        ...
        {particiones[posicionDisco].map((row,i) => (
          ...
          <DataTable.Row >
              ...
              <DataTable.Cell style={{backgroundColor: '#F2C46D'}}>
